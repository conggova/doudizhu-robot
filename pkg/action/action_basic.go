...
func getWZ() Action {
	return Action{0x0D000209, 0x110000000000000}
}

func getWZPS() PokerSet2 {
	return 0x110000000000000
}
...
func (a Action) SetAff(ps PokerSet2) Action {
	afflen := ps.PokerCount()
...
func (a Action) IsBomb() bool {
	return a[0]&255 == Bomb || a[0]&255 == WZ
}
